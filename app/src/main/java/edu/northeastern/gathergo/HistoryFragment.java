...
public class HistoryFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        recyclerView = view.findViewById(R.id.historyListView);
        Bundle args = getActivity().getIntent().getExtras();
        String theCurrentUser = args.getString("userId");
        DatabaseReference userRef = rootRef.child("Users").child(theCurrentUser).child("addedEvents");
    ...
    private void initRecyclerView() {
        adapter = new EventAdapter(eventList, getContext(),null);
        RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(getActivity());
        recyclerView.setLayoutManager(layoutManager);
